...
sys.path.insert(0, os.path.join(PROJECT_ROOT, "..", "crapvine"))
...
STATICFILES_DIRS = (
    ('test-crapvine-online', os.path.join(PROJECT_ROOT, 'media')),
...
SECRET_KEY = 'ok!9kiv=q%%qu_c)xe+wpuc0br2$r18ij!5c1vb^itgbf5f0&e'
